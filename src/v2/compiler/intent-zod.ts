...
export const CompilerOperationSchema = z.object({
  kind: z.enum(["upload", "file-to-image", "enhance-prompt", "upscale-image", "edit-image", "reference-image-edit", "generate-image", "generate-video", "export", "output-result", "unknown"]),
